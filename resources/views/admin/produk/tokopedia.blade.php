			...
			<div class="page-header">
				<div class="page-header-content">
					<div class="page-title">
						<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Sistem Informasi Webscraping</span> - Data Produk Tokopedia</h4>
					</div>
				...
				<div class="breadcrumb-line breadcrumb-line-component">
					<ul class="breadcrumb">
						...
						<li class="active">Data Produk Tokopedia</li>
					</ul>
				</div>
			</div>
			<!-- /page header -->
			...
			<div class="content">
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Data Produk Tokopedia</h5>
					...
					<table class="table datatable-basic">
						...
						<tbody>
									@foreach ($tokopedias as $tokopedia)
							<tr>

								<td>
									<img src="{{$tokopedia->foto}}" alt="" class="img-rounded img-preview">
								</td>
								<td>{{$tokopedia->nama_barang}}</td>
								<td>{{$tokopedia->harga}}</td>
								<td>{{$tokopedia->stock}}</td>
								<td>
									@if ($tokopedia->stock>=1)
									...
									<ul class="icons-list">
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right">
												<li><a href="{{$tokopedia->url}}"><i class="fas fa-globe"></i> GO TO URL</a></li>
												<li><a href="{{route('lihatproduk', ['mp' => 'tokopedia','id'=>$tokopedia->id])}}"><i class="fas fa-eye"></i> Lihat</a></li>
												<li><a href="#modal_edit" class="editbutton" data-toggle="modal" data-id="{{$tokopedia->id}}"><i class="fas fa-edit"></i> Edit</a></li>
												<li><a href="#modalHapus" class="hapusbutton" data-toggle="modal" data-id="{{$tokopedia->id}}" data-nama="{{$tokopedia->nama_barang}}"><i class="fas fa-trash-alt"></i> Hapus</a></li>
											</ul>
										</li>
									</ul>
								</td>
...
<!-- /page container -->
	...
	<div id="modal_edit" class="modal fade">
		<div class="modal-dialog modal-lg" style="width:1250px">
			<div class="modal-content" style="width:1200px">
				...
				<form action="{{route('updatemodaltokopedia')}}" class="form-horizontal" method="post">
					{{ csrf_field() }}
							...
							<div class="col-md-6">
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<select class="select-search select-border-color border-warning" name="modal_cat1" id="modal_categori1" required>
	...
	<div id="modalHapus" class="modal fade" tabindex="-1">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<form action="{{route('hapusmodaltokopedia')}}" method="post">
						@csrf
	...
	<script>
		...
		$(document).on('click', '.editbutton', function(e){
			// $('.editbutton').click(function(){
				...
				$.get('{{URL::to("dropshipper/tokopedia/edit") }}/' + iD, function (data){
					$.each(data, function (index,tokopedias_edit) {
						$('#id_edit').val(iD);
						$('#modal_nama_barang').val(tokopedias_edit.nama_barang);
						$("#modal_url2").val(tokopedias_edit.url);
						$("#modal_foto").attr('src', tokopedias_edit.foto);
						$("#modal_foto2").val(tokopedias_edit.foto);
						$('#modal_harga').val(tokopedias_edit.harga);
						// $('#modal_deskripsi').data("wysihtml5").editor.setValue(tokopedias_edit.deskripsi);
						CKEDITOR.instances.editor1.setData(tokopedias_edit.deskripsi);
						$('#modal_berat').val(tokopedias_edit.berat);
						$('#modal_stock').val(tokopedias_edit.stock);
						$('#modal_categori1').val(tokopedias_edit.cat1).change();
						$('#modal_categori2').val(tokopedias_edit.cat2).change();
						$('#modal_categori3').val(tokopedias_edit.cat3);
						$('#modal_ukuran').val(tokopedias_edit.ukuran).change();
						$('#modal_warna').val(tokopedias_edit.warna);
						var id_cate2 = tokopedias_edit.cat2;
						var id_cate3 = tokopedias_edit.cat3;
						// console.log(id_cat2);
						$.get('{{ URL::to("ajaxcat2/") }}/' + tokopedias_edit.cat1, function(data){
							$('#modal_categori2').empty();
							$.each(data, function(index, id_cat2){
								var select="";
						...
						$.get('{{ URL::to("ajaxcat3/") }}/' + tokopedias_edit.cat2, function(data){
	...
	if($('#succesToast').is(':visible')) {
		toastr.success("Data Tokopedia","Berhasil");
	}
		</script> --}}
 ...
 {{-- <script>
 	$("#editbutton").click(function (e) {
		...
		$.getJSON('dropshipper/tokopedia/edit/update' + id, function(data){

		}).done(function(element) {
			$("#modal_nama_barang").val(element.nama_barang);
			$("#modal_harga").val(element.harga);
		});
