                ...
                <div class="page-header">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><i class="fas fa-box-open position-left"></i> <span class="text-semibold">Lihat Produk</span></h4>
                        </div>
                    </div>
                        ...
                        <div class="sidebar sidebar-default sidebar-separate" style="width:307px">
                            <div class="sidebar-content">
                                ...
                                <div class="content-group">
                                  <img alt=""  id="foto" class="img-fluid img-thumbnail" style="height:342px;" src="{{$datas->foto}}"> </img>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="profile">
                                    ...
                                    <div class="panel panel-flat">
                                        ...
                                        <div class="col-xs-4">
                                            <p><i class="fas fa-weight-hanging icon-2x display-inline-block text-info"></i></p>
                                            <h5 class="text-semibold no-margin">{{$datas->berat}}</h5>
                                            <span class="text-muted text-size-small">Berat</span>
                                        </div>

                                        <div class="col-xs-4">
                                            <p><i class="fas fa-pallet icon-2x display-inline-block text-warning"></i></p>
                                            <h5 class="text-semibold no-margin">{{$datas->stock}}</h5>
                                            <span class="text-muted text-size-small">Stock</span>
                                        </div>

                                        <div class="col-xs-4">
                                            <p><i class="fas fa-tags icon-2x display-inline-block text-success"></i></p>
