...
<link href="{{asset('assets/material-icons/iconfont/material-icons.css')}}" rel="stylesheet" type="text/css">
<link href="{{asset('assets/material-datetimepicker/bootstrap-material-datetimepicker.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('js\toast\toastr.min.css')}}" rel="stylesheet" >
...
<script src="{{asset('js\toast\toastr.min.js')}}"></script>
...
<script src="{{asset('global_assets/js/demo_pages/general_widgets_stats.js')}}"></script>
<!-- /Dashboard-->
...
<script src="{{asset('global_assets/js/core/libraries/jquery_ui/widgets.min.js')}}"></script>
<script src="{{asset('global_assets/js/plugins/forms/inputs/typeahead/typeahead.bundle.min.js')}}"></script>
<script src="{{asset('global_assets/js/plugins/pickers/location/typeahead_addresspicker.js')}}"></script>
<script src="{{asset('global_assets/js/plugins/pickers/location/autocomplete_addresspicker.js')}}"></script>
<script src="{{asset('global_assets/js/plugins/pickers/location/location.js')}}"></script>
<script src="{{asset('global_assets/js/plugins/ui/prism.min.js')}}"></script>
<script src="{{asset('global_assets/js/demo_pages/picker_location.js')}}"></script>
<!-- /maps -->
...
<script src="{{asset('global_assets/js/demo_pages/user_profile_tabbed.js')}}"></script>
<!-- /user tabbed -->
